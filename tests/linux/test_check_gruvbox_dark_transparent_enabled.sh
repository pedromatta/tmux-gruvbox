...
EOF
  ...
  _status_left_expected="#[bg=#{?client_prefix,#fe8019,#665c54},fg=#{?client_prefix,#282828,#bdae93}] #S #[bg=default,fg=#{?client_prefix,#fe8019,#665c54},nobold,noitalics,nounderscore]"
