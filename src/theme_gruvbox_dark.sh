...
theme_set_dark() {
  ...
  tmux_append_setwo "window-status-current-style" "bg=${_active_window_title_bg},fg=${col_bg1}"
  ...
  tmux_append_setwo "window-status-format" "#[bg=${col_bg2},fg=${col_bg1},noitalics]#[bg=${col_bg2},fg=${col_fg4}] #I #[bg=${col_bg2},fg=${col_fg4}] #W #{?window_end_flag,#[bg=${_default_window_status_format_bg}],#[bg=${col_bg1}]}#[fg=${col_bg2},noitalics]"
}
